...
// Link to the Problem : https://leetcode.com/problems/find-minimum-time-to-reach-last-room-i/
// Difficulty : Medium 
        ...
        int minTimeToReach(vector<vector<int>>& moveTime) {
            ...
            while (!pq.empty()) {
                ...
                for (int i=0;i<l;i++) {
                    ...
                    int time = pq.top()[0], x = pq.top()[1], y = pq.top()[2]; pq.pop();
                    ...
                    if (repeat) { pq.push({time+minWait,x,y}); }
